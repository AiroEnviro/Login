...
public class Main2Activity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camera) {
            ...
            Intent v = new Intent(getApplicationContext(), RunModule.class);
            startActivity(v);

        } else if (id == R.id.nav_slideshow) {
            Intent i = new Intent(getApplicationContext(),sMain.class);
            startActivity(i);
        } else if (id == R.id.nav_manage) {
            Intent in = new Intent(getApplicationContext(),Tools.class);
            startActivity(in);
            ...
            mAuth.signOut();
            finish();
            Intent ini = new Intent(Main2Activity.this, MainActivity.class);
            startActivity(ini);
        }
